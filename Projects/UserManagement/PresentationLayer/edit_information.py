...
class EditInformation(Frame):
    def __init__(self, view, window):
        ...
        self.city_label.grid(row=5, column=1, padx=(180, 10), pady=(0, 10), sticky="w")

        self.city_entry = Entry(self.header, bootstyle=DARK)
        self.city_entry.grid(row=5, column=1, padx=(230, 10), pady=(0, 10), sticky="w")

        self.save_button = Button(self.header, text="Save", bootstyle=OUTLINE + SUCCESS,
                                  command=self.save_to_edit_information)
        self.save_button.grid(row=6, column=1, padx=(0, 10), pady=(0, 10), sticky="w")
