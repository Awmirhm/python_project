...
class SigninFrame(Frame):
    def __init__(self, view, window):
        ...
        self.city_label.grid(row=8, column=1, padx=(180, 10), pady=(0, 10), sticky="w")

        self.city_entry = Entry(self.header, bootstyle=DARK)
        self.city_entry.grid(row=8, column=1, padx=(240, 10), pady=(0, 10), sticky="w")
        #

        self.save_button = Button(self.header, text="Save", bootstyle=OUTLINE + INFO,
                                  command=self.save_to_create_account)
        self.save_button.grid(row=9, column=1, padx=(0, 10), pady=(0, 10), sticky="w")
